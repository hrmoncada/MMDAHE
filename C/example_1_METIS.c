...
Build with
  gcc example_1_METIS.c  -lmetis -o out
  gcc example_1_METIS.c -L/usr/lib/x86_64-linux-gnu  -o out

1. Henry metis own installation
header file : metis.h
/usr/projects/climate/hrmoncada/repos/Sources/parmetis-4.0.3/metis/include/metis.h
